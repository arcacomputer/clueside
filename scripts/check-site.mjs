...
const banned = ['Kenny’s private score', 'Kenny\'s private score', '100% accurate', 'Tellmark', 'Tellframe'];
for (const phrase of banned) {
  if (html.includes(phrase)) throw new Error(`Banned or misleading claim in site: ${phrase}`);
}
for (const phrase of ['96.1%', '893-image', 'illustrative', 'Images never leave your device', 'The clues stay', 'Eligible images', 'current v1.0.8']) {
